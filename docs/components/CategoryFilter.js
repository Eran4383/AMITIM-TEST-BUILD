...
import { ArtIcon } from './icons/ArtIcon.js';
import { CommunityIcon } from './icons/CommunityIcon.js';
...
export const CategoryFilter = ({ categories, selectedCategories, onCategoryToggle }) => {
  return (
